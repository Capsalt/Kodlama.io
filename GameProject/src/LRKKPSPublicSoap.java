...
public class LRKKPSPublicSoap
{
    ...
    public LRKKPSPublicSoap(){}

    public LRKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LRKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LRKExtendedSoapSerializationEnvelope envelope= new LRKExtendedSoapSerializationEnvelope(LRKExtendedSoapSerializationEnvelope.VER11);
