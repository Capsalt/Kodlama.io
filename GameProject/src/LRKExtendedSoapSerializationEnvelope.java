...
public class LRKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LRKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LRKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LRKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LRKDateTimeConverter dateTimeConverter = new LRKStandardDateTimeConverter();

    public LRKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LRKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LRKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LRKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LRKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LRKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
