...
public class VMBExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VMBDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VMBStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VMBDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VMBDateTimeConverter dateTimeConverter = new VMBStandardDateTimeConverter();

    public VMBExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VMBExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VMBMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VMBHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VMBExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VMBHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
