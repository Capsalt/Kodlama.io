...
public class VMBKPSPublicSoap12
{
    ...
    public VMBKPSPublicSoap12(){}

    public VMBKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public VMBKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VMBExtendedSoapSerializationEnvelope envelope= new VMBExtendedSoapSerializationEnvelope(VMBExtendedSoapSerializationEnvelope.VER12);
